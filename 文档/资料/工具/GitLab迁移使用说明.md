...
[文档首页](../../文档首页.html) › [资料](../开发服务器/开发服务器部署使用说明.md) › GitLab 迁移使用说明　|　[同级：GitLab 部署使用说明 →](../开发服务器/GitLab部署使用说明.md)

## 1. 目的与现状 <a id="purpose"></a>

按《[开发部署规划](../../规划/开发部署规划.html)》第 4.5、7 节，BMS 代码仓库以**自托管 GitLab 为主仓库**
...
- 《[开发部署规划](../../规划/开发部署规划.html)》：4.5 GitLab 与 CI、第 7 节开发工作流
- 《[本地资源](../../用户文档/本地资源.md)》：凭据汇总
- 《[文档首页](../../文档首页.html)》：全量文档索引

> 本文档为 AI 生成 · 依《文档生成规范》编写 · 记录 2026-08-11 实际迁移过程 · 更新日期：2026-08-11