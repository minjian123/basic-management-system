...
[文档首页](../../文档首页.md) › [资料](../工具/Ubuntu安装部署使用说明.md) › [开发服务器部署使用说明](开发服务器部署使用说明.md) › Docker Engine 部署使用说明　|　[← 总览](开发服务器部署使用说明.md)　|　[下一个：Redis →](Redis部署使用说明.md)
...
> 依《文档生成规范》编写 · 记录 2026-08-10 实际部署过程 · 更新日期：2026-08-15（data-root 迁移至 /mnt/ssd2t/docker）