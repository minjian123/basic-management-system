...
[文档首页](../../../文档首页.md) › [资料](../../) › [开发服务器](../开发服务器部署使用说明总览.md) › Windows　|　[相关：远程控制部署使用说明 →](远程控制部署使用说明.md)
...
| 机器 | 系统                                   | 角色                                               |
| ---- | -------------------------------------- | -------------------------------------------------- |
| mjbk | Ubuntu 24.04.4 LTS（桌面版）           | 开发服务器（常驻服务，见《[开发服务器部署使用说明总览](../开发服务器部署使用说明总览.md)》） |
...
- 常驻策略：合盖不休眠、禁睡眠、休眠关闭；网卡 WOL 已设（BIOS 侧待确认，见《[远程控制部署使用说明](远程控制部署使用说明.md)》第 6 节排障 5）
