...
[文档首页](../../../文档首页.html) › [知识档案](../技术栈知识档案总览.md) › [后端核心](../技术栈知识档案总览.md#backend) › Pydantic 技术介绍　|　[← 返回总览](../技术栈知识档案总览.md)
...
- 作为请求/响应模型（`schemas/` 层）的唯一建模工具，与 ORM 解耦：ORM 管存储，Pydantic 管传输，见《[项目规划说明》4 节](../../../规划/项目规划说明.html#structure)目录结构。
...
- 前后端契约一致：后端 schema 经 openapi-typescript 由 OpenAPI schema 自动生成前端 TS 类型（见《[项目规划说明》3.2 节](../../../规划/项目规划说明.html#sel-frontend)）。
- Rust 内核性能保障：高并发请求下的校验与序列化开销远低于 v1，契合 500 并发/P99 ≤ 1s 的压测目标（见《[项目规划说明》14 节](../../../规划/项目规划说明.html#perf)）。
...
| 文档 | 说明 |
| --- | --- |
| 《[项目规划说明》2.1 节](../../../规划/项目规划说明.html#stack-backend) | 技术栈：数据校验条目（Pydantic v2） |
| 《[项目规划说明》4 节](../../../规划/项目规划说明.html#structure) | 目录结构：schemas/ 层职责 |
| 《[项目规划说明》3.2 节](../../../规划/项目规划说明.html#sel-frontend) | openapi-typescript 前后端契约联动 |
...
| 《[API 接口规范](../../../规范/API接口规范.html)》 | 422 错误码与统一响应约定 |
