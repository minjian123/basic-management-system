...
[文档首页](../../../文档首页.html) › [知识档案](../技术栈知识档案总览.md) › [后端核心](../技术栈知识档案总览.md#backend) › python-socketio 技术介绍　|　[← 返回总览](../技术栈知识档案总览.md)
...
- **待办/通知实时到达**：审批待办产生、通知发布时，实时推送给对应用户，待办角标即时更新（见《[项目规划说明](../../../规划/项目规划说明.html#modules)》5 节「通知中心」）。
- **会话失效广播**：管理员强制踢出某会话时，经 Socket.IO 广播「会话失效」，关闭该会话全部实时连接，即时生效（见《[项目规划说明](../../../规划/项目规划说明.html#security)》12 节「多端会话」）。
...
- **连接数监控**：Socket.IO 连接数纳入系统监控（见《[项目规划说明](../../../规划/项目规划说明.html#modules)》5 节「系统监控」）。
...
| 文档 | 说明 |
| --- | --- |
| 《[项目规划说明](../../../规划/项目规划说明.html#modules)》5 节 | 功能模块：通知中心（待办角标实时推送）、系统监控（连接数） |
| 《[项目规划说明](../../../规划/项目规划说明.html#security)》12 节 | 认证与安全：多端会话、会话失效广播 |
