...
[文档首页](../../../文档首页.html) › [知识档案](../技术栈知识档案总览.md) › [后端核心](../技术栈知识档案总览.md#backend) › Celery 技术介绍　|　[← 返回总览](../技术栈知识档案总览.md)
...
- **定时任务**：celery beat + 自研数据库调度器——任务定义入库 `sys_task`（定义/cron/启停），beat 启动时加载、任务变更事件触发重载，页面可动态增删改与启停（见《[项目规划说明](../../../规划/项目规划说明.html#modules)》5 节「任务调度」）。
...
| 文档 | 说明 |
| --- | --- |
| 《[项目规划说明](../../../规划/项目规划说明.html#modules)》5 节 | 功能模块：任务调度（sys_task/sys_task_log、内置周期任务） |
| 《[项目规划说明](../../../规划/项目规划说明.html#datasource)》10 节 | 多数据源策略：分片表预创建（Celery 定时任务） |
| 《[项目规划说明](../../../规划/项目规划说明.html#dbrule)》11.1 节 | 数据规范：过期软删除数据由 Celery 定时物理清理 |
