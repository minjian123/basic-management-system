...
[文档首页](../../../文档首页.html) › [知识档案](../技术栈知识档案总览.md) › [后端核心](../技术栈知识档案总览.md#backend) › JWT 与 PBKDF2 技术介绍　|　[← 返回总览](../技术栈知识档案总览.md)
...
按《[项目规划说明](../../../规划/项目规划说明.html#security)》12 节"认证与安全"与 3.1 节选型说明：
...
| 文档 | 说明 |
| --- | --- |
| 《[项目规划说明](../../../规划/项目规划说明.html#security)》12 节 | 双 token、黑名单、会话校验、密码策略全套认证设计 |
| 《[项目规划说明](../../../规划/项目规划说明.html#sel-backend)》3.1 节 | JWT + Redis 会话状态校验 + PBKDF2 选型理由 |
| 《[Redis 技术介绍](Redis技术介绍.md)》 | 会话有效标记、token 黑名单的存储实现 |
| 《[authlib 技术介绍](authlib技术介绍.md)》 | SSO 认证回跳后签发 BMS 双 token 的协同 |
| 《[API 接口规范](../../../规范/API接口规范.html)》 | 401 处理、令牌刷新约定 |
