...
[文档首页](../../../文档首页.html) › [知识档案](../技术栈知识档案总览.md) › [前端](../技术栈知识档案总览.md#frontend) › vue-i18n 技术介绍　|　[← 返回总览](../技术栈知识档案总览.md)
...
- **中英文切换**：顶栏语言切换器改 `locale` 即全局生效，偏好写 localStorage 持久化，刷新后保持（见《[项目规划说明](../../../规划/项目规划说明.html#sel-frontend)》3.2 节）。
...
- **文案不硬编码**：前后端固定文案统一存 `sys_i18n_message`，页面在线维护、新增语言免发版；前端模板一律 `t('key')`，禁止写死中文（见《[国际化规范](../../../规范/国际化规范.html)》）。
...
- **文案不硬编码**：模板与 JS 提示一律走 `t('key')`，代码评审时把写死中文当缺陷处理（见《[国际化规范](../../../规范/国际化规范.html)》）。
...
| 文档 | 说明 |
| --- | --- |
| 《[项目规划说明](../../../规划/项目规划说明.html#stack-frontend)》2.2 节 | 前端技术栈（vue-i18n 条目） |
| 《[项目规划说明](../../../规划/项目规划说明.html#sel-frontend)》3.2 节 | 选型理由：运行时拉取、动态扩展、RTL |
| 《[国际化规范](../../../规范/国际化规范.html)》 | 文案入库、key 命名、回退与 RTL 约定 |
