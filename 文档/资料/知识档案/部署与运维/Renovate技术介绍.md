...
[文档首页](../../../文档首页.html) › [知识档案](../技术栈知识档案总览.md) › [部署与运维](../技术栈知识档案总览.md#ops) › Renovate 技术介绍　|　[← 返回总览](../技术栈知识档案总览.md)
...
- **定位**：BMS 依赖自动升级，自动提 MR 升级依赖（《[项目规划说明](../../../规划/项目规划说明.html#stack-ops)》2.4 节）。
- **版本**：3x.x 系列（持续快速迭代）。
- **许可**：AGPL-3.0。BMS 自托管运行、不修改源码，无传染影响（《[项目规划说明](../../../规划/项目规划说明.html#stack-license)》2.5 节）。
- **落地形态**：阶段二起以容器方式随 gitlab.yml 编排在 mjbk 运行，需 mjbk 可访问外网（《[开发部署规划](../../../规划/开发部署规划.html#server-gitlab)》4.5 节）。
...
- **依赖自动升级**：Python（pyproject / uv.lock）、前端（package.json / lockfile）、容器镜像标签统一由 Renovate 提 MR，CI 验证后人工合入（《[项目规划说明](../../../规划/项目规划说明.html#sel-ops)》3.4 节）。
- **安全补丁通道**：与 GitLab Dependency Scanning 互补——扫描发现漏洞、Renovate 提安全更新 MR（《[项目规划说明](../../../规划/项目规划说明.html#test)》16 节安全专项）。
- **运行方式**：阶段二起以容器方式随 gitlab.yml 编排，常驻 mjbk；需 mjbk 可访问外网（拉取版本发布信息），不可达时镜像同步与依赖升级暂缓（《[开发部署规划](../../../规划/开发部署规划.html#server-gitlab)》4.5 节、11 节）。
...
- **AGPL 边界**：作为独立服务运行、不改源码、不深度定制，遵守《[项目规划说明](../../../规划/项目规划说明.html#stack-license)》2.5 节约束。
- **外网依赖**：Renovate 要访问版本发布源与 GitLab API，mjbk 外网不可达时升级暂停，属预期行为（《[开发部署规划](../../../规划/开发部署规划.html#risk)》11 节）。
...
| 文档 | 说明 |
| --- | --- |
| 《[项目规划说明](../../../规划/项目规划说明.html#stack-ops)》2.4 节 | 部署与运维技术栈（依赖升级条目） |
| 《[项目规划说明](../../../规划/项目规划说明.html#sel-ops)》3.4 节 | 选型说明：原生支持自托管 GitLab、自动提 MR |
| 《[开发部署规划](../../../规划/开发部署规划.html#server-gitlab)》4.5 节 | mjbk 运行形态：随 gitlab.yml 编排、外网依赖 |
