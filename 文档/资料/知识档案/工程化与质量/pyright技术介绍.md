...
[文档首页](../../../文档首页.html) › [知识档案](../技术栈知识档案总览.md) › [工程化与质量](../技术栈知识档案总览.md#eng) › pyright 技术介绍　|　[← 返回总览](../技术栈知识档案总览.md)
...
- 作为《[项目规划说明](../../../规划/项目规划说明.html#stack-eng)》2.3 节指定的类型检查工具，采用严格类型检查（strict 模式）作为工程约束（选型依据见《[项目规划说明](../../../规划/项目规划说明.html#sel-eng)》3.3 节）。
...
- 类型安全贯通前后端：后端 Pydantic schema 与前端 TypeScript 类型经 openapi-typescript 同源生成（见《[项目规划说明](../../../规划/项目规划说明.html#sel-frontend)》3.2 节），pyright 守后端这一侧。
...
| 文档 | 说明 |
| --- | --- |
| 《[项目规划说明](../../../规划/项目规划说明.html#stack-eng)》2.3 节 | 技术栈：类型检查 = pyright |
| 《[项目规划说明](../../../规划/项目规划说明.html#sel-eng)》3.3 节 | 选型说明：严格类型检查、Pylance 即时反馈 |
