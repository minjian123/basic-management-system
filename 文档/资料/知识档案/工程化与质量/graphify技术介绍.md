...
[文档首页](../../../文档首页.html) › [知识档案](../技术栈知识档案总览.md) › [工程化与质量](../技术栈知识档案总览.md#eng) › graphify 技术介绍　|　[← 返回总览](../技术栈知识档案总览.md)
...
- 知识图谱辅助**代码理解与架构分析**：AI 助手处理代码库问题时优先 `graphify query`，关系用 `graphify path`，概念用 `graphify explain`（见《[项目规划说明](../../../规划/项目规划说明.html#stack-eng)》2.3 节"知识图谱：graphify"）。
- 图谱索引范围覆盖**代码与「文档」目录**：规划、规范、设计文档的语义层一并入图，文档与代码的关联可查（见《[项目规划说明](../../../规划/项目规划说明.html#sel-eng)》3.3 节）。
...
- **AI 能力输入源**：帮助文档智能维护以功能代码的 graphify 知识图谱为输入之一（见《[项目规划说明](../../../规划/项目规划说明.html#sel-backend)》3.1 节 AI 能力、《[LLM 适配层技术介绍](../后端核心/LLM适配层技术介绍.md)》）。
- 安装与排障细节以《[graphify 部署使用说明](../../AI/graphify部署使用说明.html)》为准（本机 Windows 环境实测）。
...
| 文档 | 说明 |
| --- | --- |
| 《[项目规划说明](../../../规划/项目规划说明.html#stack-eng)》2.3 节 | 工程化与质量技术栈（知识图谱：graphify 条目） |
| 《[项目规划说明](../../../规划/项目规划说明.html#sel-eng)》3.3 节 | 选型说明：知识图谱辅助代码理解与架构分析 |
| 《[项目规划说明](../../../规划/项目规划说明.html#sel-backend)》3.1 节 | AI 能力：帮助文档智能维护以 graphify 知识图谱为输入源 |
| 《[graphify 部署使用说明](../../AI/graphify部署使用说明.html)》 | 本机安装、首次构建、日常使用与维护的完整实录（首选阅读） |
