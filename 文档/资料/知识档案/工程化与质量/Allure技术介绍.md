...
[文档首页](../../../文档首页.html) › [知识档案](../技术栈知识档案总览.md) › [工程化与质量](../技术栈知识档案总览.md#eng) › Allure 技术介绍　|　[← 返回总览](../技术栈知识档案总览.md)
...
- 后端 pytest 与前端 Playwright 的自动化测试结果，统一经 Allure 插件生成可视化报告（见《[项目规划说明](../../../规划/项目规划说明.html#stack-eng)》2.3 节"测试报告：Allure"）。
- 报告作为 **CI 产物归档**：GitLab MR/main 流水线中生成 Allure 报告并保留为 job artifact，随时回看（见《[项目规划说明](../../../规划/项目规划说明.html#sel-ops)》3.4 节流水线说明）。
- 结果**双出口**：Allure 负责"看得见的报告"，执行结果同时经 Kiwi TCMS 官方 pytest 插件导入用例库归档，平台统计执行情况与历史（见《[Kiwi TCMS 技术介绍](KiwiTCMS技术介绍.md)》）。
- 全量回归（每阶段末、MVP 验收前）的结果以 Allure 报告形式留档，作为验收材料（见《[项目规划说明](../../../规划/项目规划说明.html#test-report)》16.5 节"测试报告"）。
...
| 文档 | 说明 |
| --- | --- |
| 《[项目规划说明](../../../规划/项目规划说明.html#stack-eng)》2.3 节 | 工程化与质量技术栈（测试报告：Allure 条目） |
| 《[项目规划说明](../../../规划/项目规划说明.html#sel-eng)》3.3 节 | 选型说明：Allure 自动化测试报告（pytest/Playwright 结果生成，CI 产物归档） |
| 《[项目规划说明](../../../规划/项目规划说明.html#test-report)》16.5 节 | 测试报告：后端 pytest + Allure 生成自动化测试报告 |
| 《[开发部署规划](../../../规划/开发部署规划.html)》7 节 | 开发工作流与 CI：Allure 报告生成归档、结果导入 Kiwi TCMS |
