...
python deploy/tools/zentao/zentao.py tasks search --server --assigned-to minjian --status doing   # 22.5 服务端过滤
python deploy/tools/zentao/zentao.py tasks search --parent 1                  # 客户端过滤：某父任务子任务（服务端不支持 parent）
