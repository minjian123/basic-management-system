...
本节对应[《项目规划说明》](../../规划/项目规划说明.html)「功能模块」之**邮件通知**模块，与「选型说明（aiosmtplib / Jinja2）」「初始化数据（基础邮件模板种子）」「认证与安全（找回密码邮件通道）」「[通知中心](17_概要设计_通知中心.md)」等章节；架构设计依据[《架构设计》](../架构设计/01_架构设计_总览.md)**18-通知公告**节点。
