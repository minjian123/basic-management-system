...
本节对应[《项目规划说明》](../../规划/项目规划说明.html)「附加业务模块规划」（23 章）与「核心数据表清单」（sys_module）；架构设计依据[《架构设计》](../架构设计/01_架构设计_总览.md)[07-模块注册](../架构设计/07_架构设计_子系统_模块注册.md)节点。
...
> 本文档为 AI 生成 · 概要设计节点 · 与《项目规划说明》《架构设计》《文档生成规范》《命名规范》配套 · 生成日期：2026-08-14