...
本文档是任务 [01 monorepo 仓库根骨架](../01_工程骨架_01_monorepo仓库骨架.md) 的**详细设计**，粒度到「按序落地、逐条验收」，是任务级执行设计，位于 `文档/设计/` 全局粗设计之下一级。两者不一致时，以本文档为 01 的执行依据；所有不一致点已逐项对齐并记录于 [第 9 节](#align)。
...
01 与 `文档/设计/` 全局设计对照后，发现 6 处矛盾 / 缺口，已逐项确认并定稿：
