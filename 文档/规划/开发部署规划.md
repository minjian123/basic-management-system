...
```bash
sudo ufw allow from <内网网段> to any port 8080,5050,2222,3306,5432,5236,6379,9000,9001,9876,10911,9200,9090,3100,3000,9093,16686,4317,4318 proto tcp
sudo ufw enable
```
...
- 本文档确定方案与节奏；**《部署手册》**（阶段九交付，规划「文档计划」节）细化 Compose 文件、环境变量清单、备份恢复演练步骤、安全响应头说明。
