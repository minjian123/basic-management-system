...
- **当前为规划与设计阶段**：技术栈、功能模块、开发计划与验收标准已定案，架构设计（01-28）、概要设计（01-34）与布局设计已就绪，尚无源代码。动手写代码前先读[《项目规划说明》](文档/规划/项目规划说明.html)。
...
完整选型、许可与合规说明见[《项目规划说明》](文档/规划/项目规划说明.html)与[《架构设计》](文档/设计/架构设计/01-架构设计-总览.html)。
...
├── 文档首页.html   # 文档全量索引
├── 规划/        # 项目规划说明、开发部署规划
├── 规范/        # 文档生成规范、命名规范、前后端开发规范
├── 资料/        # Ubuntu 安装部署、graphify、开发服务器部署说明
│   └── 开发服务器/   # 各服务部署使用说明
├── 用户文档/    # 用户手写的 md 源文档（项目规划、布局设计、本地资源）
├── 设计/        # 架构设计、概要设计、布局设计、原型设计
└── 资源/        # 文档样式等公共资源
```

- [项目规划说明](文档/规划/项目规划说明.html)：技术栈、功能模块、数据表、权限模型、开发计划与验收标准
- [开发部署规划](文档/规划/开发部署规划.html)：开发环境两台机器分工、服务部署、磁盘/端口规划
- [架构设计](文档/设计/架构设计/01-架构设计-总览.html)：总体架构与各子系统设计
- [概要设计](文档/设计/概要设计/01-概要设计-总览.html)：各功能模块详细设计
