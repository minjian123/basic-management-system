...
└── 文档/                     # 项目文档
    ...
    │   └── 组件设计/          # 1篇：字典字段组件
    ├── 资料/
    │   ├── 开发服务器/        # 10篇：各服务部署使用说明（含排障记录）
    │   ├── 工具/              # 4篇：Ubuntu 安装、GitLab 迁移、电源控制、后台执行器
    │   ├── AI/                # 3篇：本地多模态接入方案、禅道 API 使用说明、graphify 部署说明
    │   └── 知识档案/          # 72篇：71项技术介绍 + 总览（后端 34 / 前端 20 / 工程化 9 / 部署运维 8）
...
| 禅道项目管理 API（需求/任务/迭代） | [资料/AI/禅道API使用说明](文档/资料/AI/禅道API使用说明.md) |
