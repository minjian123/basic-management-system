...
- **当前为规划与设计阶段**：技术栈、功能模块、开发计划与验收标准已定案，架构设计（01-31）、概要设计（01-38）、布局设计（01-16）、组件设计与原型设计已就绪，尚无源代码。动手写代码前先读[《项目规划说明》](文档/规划/项目规划说明.md)。
- 开发环境已部署（GitLab CI、三库、开发依赖服务与测试用例平台就绪），部署细节见[《开发服务器部署使用说明》](?文档/资料/开发服务器/开发服务器部署使用说明.md（本地文档）。
...
完整选型、许可与合规说明见[《项目规划说明》](文档/规划/项目规划说明.md)与[《架构设计》](?文档/设计/架构设计/01_架构设计_总览.md。
...
├── 资料/        # 部署说明与工具文档
│   ├── 开发服务器/   # 各服务部署使用说明
│   ├── AI/       # graphify、本地多模态（识图）
│   └── 工具/      # Ubuntu 安装部署、GitLab 迁移
├── 用户文档/    # 文档源（项目规划、布局设计、本地资源）
├── 设计/        # 架构设计、概要设计、布局设计、组件设计、原型设计
└── 资源/        # 文档样式等公共资源
```

- [项目规划说明](文档/规划/项目规划说明.md)：技术栈、功能模块、数据表、权限模型、开发计划与验收标准
- [开发部署规划](文档/规划/开发部署规划.md)：开发环境两台机器分工、服务部署、磁盘/端口规划
- [架构设计](?文档/设计/架构设计/01_架构设计_总览.md：总体架构与各子系统设计
- [概要设计](?文档/设计/概要设计/01_概要设计_总览.md：各功能模块详细设计
- [文档生成规范](文档/规范/文档生成规范.md)：项目文档的格式与布局约定
- [Kiwi TCMS 部署使用说明](?文档/资料/开发服务器/KiwiTCMS部署使用说明.md：测试用例管理平台部署与使用（用例库 + 结果归档）
...
- 安装、排除规则、重建取舍、社区命名等细节见[《graphify 部署与使用说明》](?文档/资料/AI/graphify部署使用说明.md。

## 快速启动

代码就绪后按[《开发部署规划》](文档/规划/开发部署规划.md)第 5 节在开发机启动后端与前端：
