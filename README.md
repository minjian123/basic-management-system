...
- **阶段二（后端基座与服务化地基）需求基线已建（2026-09-22）**：29 条需求 / 10 域——后端基座真实实现 + 服务化地基（多服务骨架 / 服务目录与注册要素 / API 网关 / 服务间通信与一致性 / 数据拓扑升级 / 认证与服务身份 / 可观测性栈 / 多服务 CI-CD）；见《[需求总览](bms文档/项目/02_后端基座与服务化地基/需求/00_需求_后端基座与服务化地基.md)》，任务 / 计划待建。
