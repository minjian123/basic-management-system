...
export const CAPABILITY_MANIFEST: Readonly<Record<string, readonly string[]>> = {
  ...
  'ai-assistant': ['access', 'notice', 'data-state', 'option-source', 'async-task'],
  labeled: [],
  validatable: ['labeled'],
  ...
  'approval-flow': ['presigned-url', 'access', 'notice'],
  'process-modeler': ['access', 'notice'],
  mounted: [],
  'design-token': [],
  container: ['sized'],
  layout: ['sized'],
  ...
  'screen-designer': ['access', 'notice', 'data-state', 'drag-drop', 'async-task'],
  'screen-player': ['access', 'notice', 'data-state', 'async-task'],
}
