...
from app.api.deps import get_audit_search, get_file_content_search, get_global_search
...
from app.globalsearch.null import NullAuditSearch, NullFileContentSearch, NullGlobalSearch
