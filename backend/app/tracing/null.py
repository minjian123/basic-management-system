"""tracing 能力域缺省实现（Null Object）：占位返回、无副作用（02-3 自 app.tracing.base.py 迁入）。"""

from collections.abc import Mapping

from app.core.capability import BaseNullObject
from app.core.context import get_current_trace_id
from app.tracing.base import BaseTracer, SpanContext, new_span_id, new_trace_id
