"""search 能力域缺省实现（Null Object）：占位返回、无副作用（02-3 自 app.search.base.py 迁入）。"""

from app.core.capability import BaseNullObject
from app.search.base import NULL_SEARCH_HIT_ID, BaseSearchIndex, SearchDocument, SearchHit, SearchQuery, SearchResult
