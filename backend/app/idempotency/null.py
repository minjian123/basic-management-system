"""idempotency 能力域缺省实现（Null Object）：占位返回、无副作用（02-3 自 app.idempotency.base.py 迁入）。"""

from app.core.capability import BaseNullObject
from app.idempotency.base import DEFAULT_IDEMPOTENCY_TTL, IDEMPOTENCY_PAYLOAD_TYPE, IdempotencyStore
