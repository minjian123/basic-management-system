"""notify 能力域缺省实现（Null Object）：占位返回、无副作用（02-3 自 app.notify.base.py 迁入）。"""

from app.core.capability import BaseNullObject
from app.notify.base import NULL_MESSAGE_ID, BaseNotifier, NotificationMessage, SendResult
