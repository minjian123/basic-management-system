...
| 监控与追踪（后续） | Prometheus、Loki、Grafana、Alertmanager、Jaeger、otel-collector | 浏览器查看 Grafana / Jaeger |
...
graph TD
    ...
    B --> B2["monitor.yml prometheus、loki、grafana、alertmanager、jaeger、otel-collector（后续）"]
...
| prometheus | prom/prometheus | 9090 | 命名卷 | 2.5 GB（合计） | 阶段十三 |
| loki / grafana / alertmanager | grafana/loki、grafana/grafana、prom/alertmanager | 3100 / 3000 / 9093 | 命名卷 | 2.5 GB（合计） | 阶段十三 |
| jaeger / otel-collector | jaegertracing/all-in-one、otel/opentelemetry-collector | 16686 / 4317、4318 | — | 1 GB | 阶段十三 |
...
内存合计：阶段一约 8 GB，叠加边缘网关（阶段二，约 0.3 GB）后约 8.3 GB，阶段十三后约 15 GB，阶段十九后约 19 GB；叠加 GitLab（4 GB）与 Ubuntu 桌面 + Docker 开销（约 5 GB），峰值约 28 GB，32 GB 预算内留有余量，部署后监控实际占用并按第 11 节调优。
...
| 9090 / 3100 / 3000 / 9093 | Prometheus / Loki / Grafana / Alertmanager | 阶段十三起，仅内网 |
| 16686 / 4317 / 4318 | Jaeger UI / otel-collector OTLP | 阶段十三起，仅内网 |
