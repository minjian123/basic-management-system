...
| prometheus | prom/prometheus:v3.1.0 | 9090 | 命名卷 | 0.5 GB（可观测合计约 2.5 GB） | 阶段二（08 可观测性栈） |
...
| alertmanager | prom/alertmanager | 9093 | 命名卷 | 0.3 GB | 后（08_02 告警阈值锚点） |
...
| 9090 / 3100 / 3000 | Prometheus / Loki / Grafana | 阶段二（08 可观测性栈）起，仅内网；Alertmanager 9093 随后（08_02 告警锚点） |
