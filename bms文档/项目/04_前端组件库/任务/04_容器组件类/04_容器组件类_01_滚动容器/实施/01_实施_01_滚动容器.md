...
见[测试记录](../测试/01_测试_01_滚动容器.md) §3；双端全量：`apps/desktop` **49 文件 / 313 用例**（本任务新增 12）、覆盖率语句 87.68% / 分支 79.36%、体积 164.3 / 200 KB；`frontend-mobile` **31 文件 / 226 用例**（本任务新增 12）、覆盖率语句 89.1% / 分支 80.33%、体积 78.0 / 83 KB。
