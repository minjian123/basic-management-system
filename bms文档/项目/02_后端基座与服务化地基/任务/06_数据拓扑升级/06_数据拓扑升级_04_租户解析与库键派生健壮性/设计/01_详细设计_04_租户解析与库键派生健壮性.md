...
| --- | --- | --- |
| `bms_core/tests/db/test_tenant.py::test_tenant_hostname_and_exempt` | `127.0.0.1:8000` / `10.0.0.5` / `[::1]:8000` / `localhost:8000` / 形态非法域名 → `None`；合法三段域名照常返回 | IP / `localhost` 不入租户解析 |
