...
[文档首页](../../../../文档首页.md) › [01 工程骨架](../01_工程骨架.md) › 02 backend 工程初始化　|　[← 父任务](../01_工程骨架.md)
...
- [02_详细设计_01_backend工程初始化](设计/02_详细设计_01_backend工程初始化.md)（本任务详细设计，已定稿）
- [02 实施记录](实施/02_实施_01_backend工程初始化.md)（实做内容、问题与处置、验证与遗留）
- [02 测试记录](测试/02_测试_01_backend工程初始化.md)（用例、执行结果、问题与覆盖率）
- 《项目规划说明》2.1/17
