...
| --- | --- | --- | --- |
| 阶段测试报告 | **不存在**；《文档首页》与《项目规划说明》已登记落点 `项目/01_项目骨架/测试报告_项目骨架.md` | 四章节 + 复盘 + 附录取证齐备，数据来自脚本采集 | 新增 |
...
bms文档/
├── 项目/01_项目骨架/
│   ├── 测试报告_项目骨架.md                              # 新增：四章节 + 复盘 + 附录取证（本任务主交付物）
...
落点 `bms文档/项目/01_项目骨架/测试报告_项目骨架.md`（已在《文档首页》与《项目规划说明》「文档计划」节登记）。**章节固定为**（§5、附录依本轮拍板；§1~§4 依《测试规范》§12）：
...
4. **报告初稿**：按 [§4.1](#report-struct) 结构写 `测试报告_项目骨架.md`（四章节 + 复盘 + 附录）。
...
| 7 | 报告落点（沿用既有登记） | `bms文档/项目/01_项目骨架/测试报告_项目骨架.md` | [§4.1](#report-struct) |
