...
> 项目骨架 · 02 后端基座 · 04 模块注册表 · 嵌套子任务 01

[文档首页](../../../../../../文档首页.md) › [04 模块注册表](../02_后端基座_04_模块注册表.md) › 04-1 sys_module表与种子　|　[← 父任务](../02_后端基座_04_模块注册表.md)
...
| --- | --- |
| 编号 | 02-4-1 |
| 父任务 | [04 模块注册表](../02_后端基座_04_模块注册表.md) |
| 对应需求 | [02-10](../../../../需求/02_需求_后端基座.md#r02-10) |
| 工时（重估） | 3h |
| 依赖 | 03（多租户数据拓扑：三库拓扑与建库 / 平台库基础表） |
| 负责人 | minjian |
| 状态 | 未开始 |
| 完成日期 | — |
