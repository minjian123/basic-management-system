...
- **真实权限查询**：`data:plain` 由 RBAC 权限码集合判定，随 RBAC 阶段替换 `NullPermissionChecker`；三权分立与「安全管理员分配 `data` 权限码」口径由 [《架构设计 · 权限计算引擎》](../../../../../../../设计/架构设计/14_架构设计_子系统_权限计算引擎.md) 承接。
