...
- **依据**：需求 [02-5](../../../../../需求/02_需求_后端基座.md#r02-5)、《[架构设计 · 后端基础类体系](../../../../../../../设计/架构设计/33_架构设计_后端基础类体系.md)》「基类清单与继承链」节「各层基类与模块约定」节、《[架构设计 · 数据访问与分片](../../../../../../../设计/架构设计/09_架构设计_子系统_数据访问与分片.md)》、《[后端开发规范](../../../../../../../规范/后端开发规范.md)》「后端基座体系（强制）」节、《[命名规范](../../../../../../../规范/命名规范.md)》「后端命名」节。
...
bms文档/
├── 设计/架构设计/33_架构设计_后端基础类体系.md   # 修改：§3/§4/§7 登记三层仓储
...
- 覆写 `list` / `get` / `count` / `create` / `update` / `delete` 抛 `NotImplementedError`（文案「数据库实现由 02-5-1 数据访问底座接入」）。
