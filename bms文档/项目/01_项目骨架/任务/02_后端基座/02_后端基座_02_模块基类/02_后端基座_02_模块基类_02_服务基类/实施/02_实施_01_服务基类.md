...
5. **登记**：《架构设计 · 后端基础类体系》§3 基类体系表 / §4 基类清单与继承链 / §7 模块约定，《后端开发规范》§3.1 / §3.4 / §3.6 登记分层、工作单元与事务口径。
...
7. **验证**：`uv run pytest` / `uv run ruff check .` / `uv run pyright` 全绿，覆盖率 100%（详见[测试记录](../测试/02_测试_01_服务基类.md)）。
