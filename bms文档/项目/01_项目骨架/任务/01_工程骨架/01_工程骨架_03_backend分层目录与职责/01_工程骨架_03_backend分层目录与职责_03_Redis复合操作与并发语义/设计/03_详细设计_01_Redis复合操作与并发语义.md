...
- **依据**：需求 [01-3](../../../../../需求/01_需求_工程骨架.md#r01-3) 第 7 条、01-3-2 设计 §5.2/§10 开放项、《[后端开发规范](../../../../../../../规范/后端开发规范.md)》「异步与并发」节、2026-09-10 偏差核对结论。
...
- Redis Cluster 下 WATCH 的跨槽限制随部署口径（当前单实例 compose），Cluster 适配随阶段十二。
