...
4. 结论落 `backend/README.md`「依赖与版本」节；回退时同步更新《项目规划说明》2/17 与《开发部署规划》第 10 节
...
- 《项目规划说明》2/3.1/17
- [05-1 CI 流水线激活](../../05_CI与阶段验收/05_CI与阶段验收_01_CI流水线激活/05_CI与阶段验收_01_CI流水线激活.md)（锁文件变更触发基础镜像重建）
