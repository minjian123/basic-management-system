...
> 项目骨架 · 01 工程骨架 · 04 apps/desktop 工程初始化 · 嵌套子任务 01

[文档首页](../../../../../../文档首页.md) › [04 apps/desktop 工程初始化](../01_工程骨架_04_frontend工程初始化.md) › 01 前端基础类　|　[← 父任务](../01_工程骨架_04_frontend工程初始化.md)
...
| 工时（重估） | 6h |
| 依赖 | 04（apps/desktop / frontend-mobile 工程初始化） |
| 负责人 | minjian |
| 状态 | 已完成 |
| 完成日期 | 2026-09-10 |
...
- [04 apps/desktop 工程初始化](../01_工程骨架_04_frontend工程初始化.md)（上游：工程初始化与 Axios 基线）
