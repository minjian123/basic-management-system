...
> 阿里云 PyPI 镜像为约定源（见工作区根《AGENTS.md》「网络与镜像」）。
...
> 2026-09-10 联调。mjw 已装 **PowerShell 7.6.6**（见《[开发服务器Windows部署使用说明总览](开发服务器Windows部署使用说明总览.md)》「已就绪项」节）；Windows PowerShell 5.1 语法/输出受限，作为薄壳保留。
