...
> 随后 Docker data-root 迁至 `/mnt/ssd2t/docker`、GitLab 数据迁至 `/mnt/ssd2t/gitlab`（迁移过程见《[Docker部署使用说明](../开发服务器/linux/Docker部署使用说明.md)》2.4 与《[GitLab部署使用说明](../开发服务器/linux/GitLab部署使用说明.md)》「Compose 配置」节）。
