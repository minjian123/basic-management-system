...
- **安装方式**：mjbk 为 Ubuntu 24.04.4，apt 清华 docker-ce 源直装 Docker Engine，systemd 开机自启（见《[Docker 部署使用说明](?../../开发服务器/linux/Docker部署使用说明.md》）。
...
| 《[Docker 部署使用说明](?../../开发服务器/linux/Docker部署使用说明.md》 | mjbk Docker 安装与配置内部文档 |
