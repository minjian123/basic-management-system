...
- **定位**：本项目可观测性三件套中的日志层，聚合 structlog 日志跨实例检索（平台《架构设计 · 总体架构》「技术栈全景 · 部署与运维」节）。
- **版本**：3.x 系列（持续迭代）。
...
- **采集器选型**：promtail 已进入维护模式，新部署直接用 Grafana Alloy（平台《架构设计 · 总体架构》「技术栈全景 · 部署与运维」节监控栈配套）。
...
| 文档 | 说明 |
| --- | --- |
| 平台《架构设计 · 总体架构》「技术栈全景 · 部署与运维」节 | 部署与运维技术栈（日志条目） |
