...
- **frontend/apps/mobile 独立工程**：Vue 3 + Vant 的移动端 H5 工程，与 PC 端 frontend/apps/desktop 各自独立（各自 package-lock.json、ESLint/Prettier/TS 配置，互不共享），复用后端 API 与会话体系（见平台《项目规划说明》「前端」节、平台《项目规划说明》「项目目录结构」节）。
