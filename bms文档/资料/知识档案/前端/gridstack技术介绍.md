...
[文档首页](../../../文档首页.md) › [知识档案](../技术栈知识档案总览.md) › [前端](../技术栈知识档案总览.md#apps/desktop) › gridstack.js 技术介绍　|　[← 返回总览](../技术栈知识档案总览.md)
...
- **升级走评审**：大版本变更升级走人工评审 + 回归，重点验证布局存取兼容。
...
| 文档 | 说明 |
| --- | --- |
| 平台《架构设计 · 总体架构》「技术栈全景 · 前端」节 | 前端技术栈（gridstack.js 条目） |
