...
[文档首页](../../../文档首页.md) › [知识档案](../技术栈知识档案总览.md) › [前端](../技术栈知识档案总览.md#apps/desktop) › Pinia 技术介绍　|　[← 返回总览](../技术栈知识档案总览.md)
...
- **定位**：本项目前端（frontend/apps/desktop / frontend/apps/mobile）全局状态管理，负责会话、用户信息、权限、偏好等跨页面状态。
...
- **官方状态管理（2.2 节）**：Pinia 取代 Vuex，TS 支持好（见平台《架构设计 · 总体架构》「技术栈全景 · 前端」节与 3.2 节选型理由）。
...
| 文档 | 说明 |
| --- | --- |
| 平台《架构设计 · 总体架构》「技术栈全景 · 前端」节 | 前端技术栈（Pinia 条目） |
| 平台《项目规划说明》「项目目录结构」节 | 目录结构：apps/desktop/src/stores/ 组织方式 |
