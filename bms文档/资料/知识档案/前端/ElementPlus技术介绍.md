...
[文档首页](../../../文档首页.md) › [知识档案](../技术栈知识档案总览.md) › [前端](../技术栈知识档案总览.md#apps/desktop) › Element Plus 技术介绍　|　[← 返回总览](../技术栈知识档案总览.md)
...
- **定位**：本项目  PC 管理端（frontend/apps/desktop）的 UI 组件库，覆盖后台全部界面场景。
...
- **PC 管理端全部界面组件**：表格（el-table）、表单（el-form）、树（el-tree）、弹窗（el-dialog）、上传等覆盖后台全场景（见平台《项目规划说明》「前端」节）。
- **中文社区生态最大**：问题检索与组件用法资料最全，团队上手与排障成本低（见平台《架构设计 · 总体架构》「技术栈全景 · 前端」节）。
...
- **移动端不用它**：frontend/apps/mobile 用 Vant，两套组件库互不混用（见《[Vant 技术介绍](Vant技术介绍.md)》）。
...
| 文档 | 说明 |
| --- | --- |
| 平台《架构设计 · 总体架构》「技术栈全景 · 前端」节 | 前端技术栈（Element Plus 条目） |
| 平台《项目规划说明》「前端」节 | 选型理由：生态最大、组件齐全、主题可定制 |
