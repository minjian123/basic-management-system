...
[文档首页](../../../文档首页.md) › [知识档案](../技术栈知识档案总览.md) › [前端](../技术栈知识档案总览.md#apps/desktop) › ECharts 技术介绍　|　[← 返回总览](../技术栈知识档案总览.md)
...
- **报表渲染**：拖拽报表设计器产出的 `rpt_report.chart_config`（ECharts 配置）直接驱动渲染（见平台《项目规划说明》「前端」节）。
...
- **中文生态最全**：图表类型覆盖管理端全场景，资料与示例丰富，团队上手快（见平台《项目规划说明》「前端」节）。
