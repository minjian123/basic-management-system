...
[文档首页](../../../文档首页.md) › [知识档案](../技术栈知识档案总览.md) › [前端](../技术栈知识档案总览.md#apps/desktop) › vue-i18n 技术介绍　|　[← 返回总览](../技术栈知识档案总览.md)
...
- **中英文切换**：顶栏语言切换器改 `locale` 即全局生效，偏好写 localStorage 持久化，刷新后保持（见平台《项目规划说明》「前端」节）。
...
| 文档 | 说明 |
| --- | --- |
| 平台《架构设计 · 总体架构》「技术栈全景 · 前端」节 | 前端技术栈（vue-i18n 条目） |
| 平台《项目规划说明》「前端」节 | 选型理由：运行时拉取、动态扩展、RTL |
