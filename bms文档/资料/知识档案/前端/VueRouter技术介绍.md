...
TypeScript 编写。本项目的 PC 管理端（apps/desktop）与移动端 H5（frontend-mobile）
均为 SPA，路由是页面组织的骨架。
...
- **前端路由（2.2 节）**：apps/desktop 与 frontend-mobile 双工程各自使用 Vue Router 4 管理页面导航（见平台《架构设计 · 总体架构》「技术栈全景 · 前端」节）。
