...
[文档首页](../../../文档首页.md) › [知识档案](../技术栈知识档案总览.md) › [前端](../技术栈知识档案总览.md#apps/desktop) › Vitest 技术介绍　|　[← 返回总览](../技术栈知识档案总览.md)
...
- **定位**：本项目前端单元测试/组件测试框架，内置 coverage 统计前端覆盖率，CI 门禁之一（见平台《架构设计 · 总体架构》「技术栈全景 · 前端」节）。
...
- **前端单元测试**：工具函数、API 封装、状态逻辑（Pinia store）的纯逻辑测试（见平台《项目规划说明》「前端」节）。
...
| 文档 | 说明 |
| --- | --- |
| 平台《架构设计 · 总体架构》「技术栈全景 · 前端」节 | 前端技术栈（Vitest 条目） |
| 平台《项目规划说明》「前端」节 | 选型理由：与 Vite 同构、内置 coverage |
| 平台《项目规划说明》「测试策略与测试流程」节 | 测试策略：覆盖率门槛与测试报告归档 |
