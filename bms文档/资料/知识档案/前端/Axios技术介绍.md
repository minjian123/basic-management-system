...
[文档首页](../../../文档首页.md) › [知识档案](../技术栈知识档案总览.md) › [前端](../技术栈知识档案总览.md#apps/desktop) › Axios 技术介绍　|　[← 返回总览](../技术栈知识档案总览.md)
...
| 文档 | 说明 |
| --- | --- |
| 平台《架构设计 · 总体架构》「技术栈全景 · 前端」节 | 前端技术栈（Axios 条目） |
| 平台《项目规划说明》「前端」节 | 选型理由：统一封装请求/响应拦截器 |
