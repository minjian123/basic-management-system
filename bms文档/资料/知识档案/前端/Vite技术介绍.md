...
[文档首页](../../../文档首页.md) › [知识档案](../技术栈知识档案总览.md) › [前端](../技术栈知识档案总览.md#apps/desktop) › Vite 技术介绍　|　[← 返回总览](../技术栈知识档案总览.md)
...
- **定位**：本项目前端开发服务器与生产构建工具，frontend/apps/desktop 与 frontend/apps/mobile 双工程共用。
...
- **frontend/apps/desktop 与 frontend/apps/mobile 双工程各自独立配置**：各自维护 vite.config.ts（代理、别名、构建输出），互不影响（见平台《项目规划说明》「前端」节）。
...
| 文档 | 说明 |
| --- | --- |
| 平台《架构设计 · 总体架构》「技术栈全景 · 前端」节 | 前端技术栈（Vite 条目） |
