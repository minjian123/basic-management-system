...
| 文档 | 说明 |
| --- | --- |
| 平台《项目规划说明》「认证与安全」节 | SSO 登录、JIT 建号、本地应急登录、移动端免登全套设计 |
| 平台《项目规划说明》「后端核心」节 | authlib 选型理由（OIDC 为主 + CAS 兼容） |
| 《[JWT 技术介绍](JWT与PBKDF2技术介绍.md)》 | SSO 回跳后签发双 token 的认证骨架 |
| 《[Redis 技术介绍](Redis技术介绍.md)》 | 会话标记与踢出即时生效 |
| 平台《项目规划说明》「出站集成（BMS 调外部）」节 | 本项目对外提供认证能力的出站集成视角 |
