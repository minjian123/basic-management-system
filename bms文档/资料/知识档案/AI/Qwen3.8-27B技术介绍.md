...
| N片段Repo-Bench（仓库级生成） | 42.3 | 36.2 | 41.1 | **47.6** |
...
- **OCR 复杂场景切换**：本项目阶段十七 OCR 默认 PaddleOCR，复杂版面/公式可切换多模态模型（平台《项目规划说明》「后端核心」节），本模型是该路径的本地引擎候选（见《[PaddleOCR 技术介绍](../后端核心/PaddleOCR技术介绍.md)》选型对比）。
