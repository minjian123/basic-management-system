...
- 语言包运行时拉取（`GET /api/v1/i18n/messages`，Redis + localStorage 二次缓存）见[《架构设计 · 国际化》](../../../架构设计/23_架构设计_子系统_国际化.md)。
...
| 慢请求观测 | 记录耗时，超阈值（如 3s）打点告警（接入[《架构设计 · 可观测性》](../../../架构设计/26_架构设计_子系统_可观测性.md)） |
