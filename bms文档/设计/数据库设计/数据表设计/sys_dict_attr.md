# sys_dict_attr（字典扩展属性定义表）

> BMS · 数据库设计 · 数据表设计

[文档首页](../../../文档首页.md) › [数据库设计总览](../01_数据库设计_总览.md) › [已设计数据表登记](../01_数据库设计_总览.md#tables-registry) › sys_dict_attr
...
| ORM 模型 | `app/dict/models.py::SysDictAttr`（继承 `BaseModel`） |
