...
架构设计依据[《架构设计》](../架构设计/01_架构设计_总览.md)20-通知公告节点与 16-实时推送节点。
...
- **协作关系**：
  - 实时推送（[架构 13](../架构设计/16_架构设计_子系统_实时推送.md)）：新站内信广播 notification.new；审批待办广播 approval.todo；批量已读同步角标状态
  - 工作流（[架构 16](../架构设计/19_架构设计_子系统_工作流.md)）：审批待办生成 → 站内信落库 + 实时触达
