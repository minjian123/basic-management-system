...
| AI 智能维护（后续） | AI 生成/更新草稿、form.updated 事件自动触发、质量评估报告；结果一律为草稿，人工审核后发布 | help:manage |
...
- **sys_config 参数**：无独立业务参数；AI 帮助维护相关开关随 AI 能力（后续）管理
...
| 帮助管理（文章维护） | PC | 文章在线编辑（草稿/发布/下架/置顶）、target 关联、多语言维护、统计视图、AI 生成草稿入口（后续） |
