...
本节对应[《项目规划说明》](../../规划/项目规划说明.md)「功能模块」之**角色管理**模块，与「权限模型」「业务与动作清单（权限码总表）」「核心数据表清单」「[审计合规](28_概要设计_审计合规.md)」（三权分立）章节。架构设计依据[《架构设计》](../架构设计/01_架构设计_总览.md)11-权限计算引擎节点。
