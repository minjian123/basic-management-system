...
[《架构设计》](../架构设计/01_架构设计_总览.md)20-工作流节点、17-实时推送节点与 21-通知公告节点。
...
- **协作关系**：
  ...
  - 通知与实时推送（[架构 17](../架构设计/21_架构设计_子系统_通知公告.md)/[架构 13](../架构设计/17_架构设计_子系统_实时推送.md)）：待办生成 → 站内信 + Socket.IO（approval.todo）+ 待办角标
