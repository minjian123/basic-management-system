...
| GET/POST/PUT/DELETE | /dicts/query-schemes | 查询方案 CRUD（scope=platform/tenant/user；个人方案登录即可，平台/共享方案需 `dict:query-scheme`） | 登录即可 / dict:query-scheme |
